  ...
  return (
    <div className="flex flex-col gap-2 h-full">
              ...
              <div className="flex flex-col gap-2 pt-2">
                {category.nodes.map((node) => (
                  <Button
                    key={node.type}
                    variant="outline"
                    className="justify-start text-left h-auto py-2 hover:bg-gray-100 hover:border-blue-500 active:scale-95"
                    draggable
      ...
      <div className="mt-4 text-xs text-gray-500">
        <div>Drag and drop nodes onto the canvas to build your workflow</div>
        <div className="mt-2 p-2 bg-gray-100 rounded-md">
          <p className="font-medium">Node Tips:</p>
          <ul className="list-disc list-inside mt-1">
            <li>Drag off canvas to delete</li>
            <li>Press Delete/Backspace to remove</li>
            <li>Select + click Delete button</li>
          </ul>
        </div>
      </div>
    </div>
